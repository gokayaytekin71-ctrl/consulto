  ...
  return (
    <header className="relative z-30 flex h-[72px] shrink-0 items-center gap-3 overflow-hidden border-b border-slate-200/70 bg-white/85 px-3 backdrop-blur-2xl md:h-[86px] md:px-5">
      <div className="flex min-w-0 flex-1 items-center gap-2 md:gap-3">
        ...
        <div className="relative min-w-0 flex-1 sm:w-[300px] sm:flex-none xl:w-[360px] 2xl:w-[430px]" ref={dropdownRef}>
          <button
          ...
          >
            <div className="flex min-w-0 flex-1 items-center gap-3">
              ...
              <div className="flex min-w-0 flex-1 flex-col items-start">
                ...
                <div
                  className="w-full overflow-hidden break-words text-left text-sm font-black leading-4 text-slate-900 [display:-webkit-box] [-webkit-box-orient:vertical] [-webkit-line-clamp:2]"
        ...
        <div className="hidden w-[230px] min-w-0 shrink items-center rounded-[1.35rem] border border-slate-200 bg-slate-50 p-1 shadow-sm xl:flex 2xl:w-[250px]">
          <button
            type="button"
      ...
      <div className="hidden min-w-0 shrink-0 items-center gap-2 xl:flex">
        <div className={`hidden max-w-[150px] items-center gap-2 rounded-2xl border px-3 py-2 text-[11px] font-black shadow-sm 2xl:flex 2xl:max-w-none 2xl:px-3.5 ${Number.isFinite(Number(tokenBalance)) && Number(tokenBalance) < currentMessageTokenCost ? "border-red-200 bg-red-50 text-red-600" : "border-emerald-200/70 bg-gradient-to-r from-emerald-50 to-teal-50 text-emerald-700"}`}>
        ...
        {!isPetitionDesk && (
        <div className="flex min-w-0 items-center rounded-[1.4rem] border border-slate-200 bg-white px-2 py-1.5 shadow-sm">
        <button
          type="button"
          onClick={() => toggleVisiblePanel("decisions")}
          className={`group flex min-w-0 items-center gap-1.5 rounded-2xl px-2.5 py-2 text-[11px] font-black transition-all 2xl:gap-2 2xl:px-3.5 2xl:text-xs ${
