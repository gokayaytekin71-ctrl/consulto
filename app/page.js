                ...
                <div className="mx-auto max-w-7xl relative z-10">
                    ...
                    <div className="text-center mb-16 relative">
                        ...
                        <p className="max-w-2xl mx-auto text-xl text-slate-600 font-medium leading-relaxed mb-8">
                            Milyonlarca Yargıtay Kararını ezbere bilen Türk Hukuku Dokümanları ile <strong>Eğitilmiş</strong> Yapay Zeka Asistanınız.
                        </p>
        ...
        Hemen Giriş Yap! <span className="font-extrabold">2 Token ÜCRETSİZ Tanımlansın ve Anında Dene</span>
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                          ...
                          >
                                ...
                                <span> Paketleri İncele & Başla</span>
                          </Link>
                          <Link
                            href="/akilli-arama"
              ...
              <p className="text-slate-600 text-lg leading-relaxed">
                ...
                <section>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
                        ...
                        <ToolCard href="/araclar/vekalet-ucreti-hesaplama" title="Vekâlet Ücreti" subtitle="AAÜT 2025-2026" icon={<svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg>} />
