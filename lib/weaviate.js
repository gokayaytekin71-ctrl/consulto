...
// Python uygulamanın (app.py) çalıştığı adres ve port. (Genelde Flask 5000 portunda çalışır)
const PYTHON_API_URL = process.env.PYTHON_API_URL || "http://51.159.28.179:5000"; 
